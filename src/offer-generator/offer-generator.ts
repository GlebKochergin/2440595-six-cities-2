import {generateRandomNumber, getRandomItem, getRandomItems} from '../internal/helpers';
import {MockData} from '../internal/types';
import dayjs from 'dayjs';
import {UserType, Facility, Housing, City} from '../internal/types';
